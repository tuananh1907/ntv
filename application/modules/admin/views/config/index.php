<div id="page-wrapper">
  <form method='post' enctype='multipart/form-data'><!--day la cai form hien tai-->
    <div id="main-wrapper">
        <div id="main-header">
			...
			<div class="divTab">
                            ...
                            <div class="tab0 tabcontent ui-corner-all">
                                ...
                                <label class="desc" >
                                   ...
                                   <input name='config[_smtp_password_]' type="password" class="full" value='<?php echo config('_smtp_password_'); ?>' />
                                
                                <label class="desc" >
                                    <?php echo $this->lang->line('txt_email_subject')?>
                                </label> 
                                   <input name='config[_email_subject_]' type="text" class="full" value='<?php echo config('_email_subject_'); ?>' />
                                <label class="desc" >
								...
								<label class="desc" >
                                    <?php echo $this->lang->line('txt_smtp_name_sender')?>
                                </label>
                                   <input name='config[_smtp_name_sender_]' type="text" class="full" value='<?php echo config('_smtp_name_sender_'); ?>' />
							</div>
                            ...
                            <div class="tab2 tabcontent ui-corner-all">
                                ...
                                <label class="desc">Google Map trên Mobile</label>
                                   <textarea name='config[_google_map_mobile_]' class="full" rows="10"><?php echo config('_google_map_mobile_'); ?></textarea>
                                <label class="desc" >Địa chỉ trên Mobile</label>
                                   <textarea name='config[_address_mobile_]' class="full" rows="7"><?php echo config('_address_mobile_'); ?></textarea>
                            
                            </div>
                            <div class="tab3 tabcontent ui-corner-all">
                                <label class="desc">Upload</label>
                                <input type="file" name="photo"></br>
                                <small>File ảnh đuôi gif/ico. Kích thước < 2Mb</small>
                                <img src="/upload/favicon.ico" width='32' height='32'>
