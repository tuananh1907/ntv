...
class Parent_Controller extends Core_Controller
{
    ...
    protected  function get_page($module) {
    ...
    private function get_menu()
    {
        ...
        foreach ($languages as $l) {
            if ($l['language_id'] == LANGUAGE) {
                $this->data['menu_list'] = get_list_by_language_id($l['language_id'], $rs);
            }
            /*else {
    ...
    /*private function get_ads() {
            ...
            $this->data['adsmobile'] = $this->media_default_model->get_gallery('adsmobile', LANGUAGE);
    }*/
