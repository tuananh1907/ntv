    ...
    <div class="block-left">
        ...
        <ul class='menu-list'>
            <?php foreach ($categories as $cs) { ?>
                <li>
                    <a href="<?php short_url('productcat-item', array($cs['alias_name'])) ?>"><?php echo $cs['category_title'] ?></a>
                </li>
            <?php } ?>
        ...
        <div class="col-lg-6 tag-area">
            <ul class='tag'>
                ...
                for ($i = 0; $i < $r; $i++) {
                    ?>
                    <li><label></label><a
                            href="<?php echo $shape[$i]['tag_id'] ?>"><?php echo $shape[$i]['title'] ?></a></li>
                <?php } ?>
            </ul>
        </div>
        <div class="col-lg-6 tag-area">
...
<div class="col-lg-9 content-right">
    ...
    <div class="content-right-center detail">
        <div class="col-lg-6 gallery">
            <div class="col-lg-12">
                <?php if (count($gallery)) { ?>
                    <img class='img-responsive' src="<?php echo $gallery[0]['img'] ?>">
                <?php } ?>
            </div>
            <?php
            if (!empty($gallery)) {
        ...
        <div class="col-lg-6 no-padding-right">
            ...
            <div class='tech'>Thông số kĩ thuật
                <div class='d-se'></div>
            </div>
            <ul class='tech-list'>
            ...
            <div class='tech'>Tài liệu chi tiết kĩ thuật
                <div class='d-se'></div>
            </div>
            <div><a href="<?php echo ( !empty($document)?$document: '#' )?>" target="_blank"><img src="<?php echo DEFAULT_IMAGE_PATH; ?>/file.png"></a></div>
        </div>
                ...
                foreach ($posts_category as $pc) {
                    ...
                    <li>
                        <div class='p-item-img'>
                            ...
                            <a href="<?php short_url('product-item', array($pc['alias_name'])) ?>">
                                <div class='bg'>
                        ...
                        <p>
                            <a href="<?php short_url('product-item', array($pc['alias_name'])) ?>"><?php echo $pc['post_title'] ?></a>
                        </p>
                    </li>
                    <!--//item-->
                <?php } ?>
