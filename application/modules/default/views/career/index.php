                ...
                if(count($career) > 0) {
                    ...
                    <div class="h4Block">
                        <h4 class="bold"> <span class="ttl w38"><?php echo $this->lang->line('txt_position');?></span>: <?php echo $c['post_title']?><br />
                            <span class="ttl w38"><?php echo $this->lang->line('txt_quantity');?></span>: <?php echo $c['meta']['_quantity']?><br />
                            <span class="ttl w38"><?php echo $this->lang->line('txt_deadline');?></span>: <?php echo my_date_format($c['meta']['_deadline'])?></h4>
                    ...
                    echo $this->lang->line('txt_no_data');
                }   
                ?>
            </div>
        </div>
