...
<?php 
    echo ( isset( $config['_tracking_code_'])  ? $config['_tracking_code_'] : '');
?>
</head>
...
<div id="wrapper">
    <div id="header" class="clearfix">
        ...
        {
        ?>
            <?php if(!empty($page['post_featured_image'])) { ?>
            <h2 class="common_h2"><img src="<?php echo $page['post_featured_image']; ?>" alt="SANKO MOLD VIETNAM" /></h2>
            <?php }?>
