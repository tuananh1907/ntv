            ...
            <div class="widget">
                <div class="whead">
                    ...
                    <div class="block-right control block-right-control-button">
                        ...
                        ?>
                        <?php
                            $category_class = (!in_array('category', $module_option)) ? 'none':'';
                            my_select(
                                $list_sort, 
                                $keywords = array('title' => 'category_title', 'value' => 'category_id', 'parent'=> 'catparent_id', 'level' => 'category_level'),
                                $attributes = array('name' => 'pid', 'id' => 'ddlInCate' , 'class' => "combobox ddlFilter " . $category_class, 'data-filter' => url_add_params($params, '/index.php/admin/post') ),
                ...
                <table class="aGrid" cellspacing="0" id="GridView1" style="border-collapse: collapse;">
                    <tbody>
                        <tr>
                            ...
                            <th class='<?php echo (!in_array('category', $module_option)) ? 'none':''; ?>'>
                                <?php echo $this->lang->line('txt_category');?>
                            </th>
                            <th>
                                <?php echo $this->lang->line('txt_show_hide');?>
                            </th>
                            <th class='<?php echo (!in_array('highlight', $module_option)) ? 'none':''; ?>'>
                        ...
                        <tr class="">
                            ...
                            <td class='<?php echo (!in_array('category', $module_option)) ? 'none':''; ?>'>
                            ...
                            <td class="cellwidth1 <?php echo (!in_array('highlight', $module_option)) ? 'none':''; ?>">
                                <?php if( check_permission($module, EDIT) ) { ?>
