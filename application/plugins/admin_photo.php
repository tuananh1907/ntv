...
//ADD
$pluggable->register_action('admin_html_post_add_block_left_photo', 'admin_html_post_add_block_left_photo_func');
$pluggable->register_action('admin_callback_after_post_added_photo', 'admin_callback_after_post_added_photo_func');

//EDIT
$pluggable->register_action('admin_html_post_edit_block_left_photo', 'admin_html_post_edit_block_left_photo_func');
$pluggable->register_action('admin_callback_after_post_updated_photo', 'admin_callback_after_post_updated_photo_func');

function admin_html_post_add_block_left_photo_func($module, $language) {
    $CI =& get_instance();
...
function admin_callback_after_post_added_photo_func($module, $lang, $post_id, $langmap_id) {
    $CI =& get_instance();
...
function admin_html_post_edit_block_left_photo_func($module = '', $language = '', $post_id = 0) {
    $CI =& get_instance();
    $CI->lang->load('plugins', ADMIN_LANGUAGE);
    $CI->load->Model('meta_admin_model');
...
function admin_callback_after_post_updated_photo_func($module, $lang, $post_id, $langmap_id) {
    $CI =& get_instance();
    $CI->load->Model('meta_admin_model');
    $gallery = $CI->input->post("gallery_" .$lang);
