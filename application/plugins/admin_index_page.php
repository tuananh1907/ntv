...
//ADD
$pluggable->register_action('admin_html_post_add_block_left_product', 'admin_html_post_add_block_left_p_func');
$pluggable->register_action('admin_callback_after_post_added_product', 'admin_callback_after_post_added_p_func');
...
function admin_html_post_add_block_left_p_func($module, $language) {
  $CI =& get_instance();
  ...
  <div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
      <div class="portlet-header ui-widget-header">
          <span class="ui-icon ui-icon-circle-arrow-s"></span>Thông số kĩ thuật
      </div>
...
function admin_callback_after_post_added_p_func($module, $lang, $post_id, $langmap_id) {
  $CI =& get_instance();
